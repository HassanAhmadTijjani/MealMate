...
using MealMate.Application.Features.Restaurants.Queries.GetRestaurant;
using MealMate.Application.Features.Restaurants.Commands.UpdateRestaurant;
using MediatR;

namespace MealMate.Api.Endpoints.Restaurant;
...
public static class RestaurantEndpoints
{
    ...
    {
        endpoints.MapPost("/api/restaurant", async (
        ...
        endpoints.MapGet("/api/restaurant", async (
     ISender sender,
     CancellationToken cancellationToken) =>
 {
     var query = new GetRestaurantQuery();

     var restaurant = await sender.Send(
         query,
         cancellationToken);
     ...
     return Results.Ok(restaurant);
        ...
        endpoints.MapPut("/api/restaurant", async (UpdateRestaurantRequest request, ISender sender, CancellationToken cancellationToken) =>
        {
